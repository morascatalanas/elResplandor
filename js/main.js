...
ctx.moveTo(altoCelda,altoCelda*2)
ctx.lineTo(anchoCelda*2,altoCelda*2)
ctx.moveTo(altoCelda,altoCelda*2)
ctx.lineTo(anchoCelda,altoCelda*4)
ctx.moveTo(altoCelda,altoCelda*4)
ctx.lineTo(anchoCelda*3,altoCelda*4)
ctx.moveTo(altoCelda*3,altoCelda*2)
ctx.lineTo(anchoCelda*3,altoCelda*4)
ctx.moveTo(altoCelda*2,altoCelda)
...
ctx.moveTo(altoCelda,altoCelda*5)
ctx.lineTo(anchoCelda*5,altoCelda*5)
ctx.moveTo(altoCelda,altoCelda*5)
ctx.lineTo(anchoCelda,altoCelda*8)
ctx.moveTo(altoCelda*2,altoCelda*10)
ctx.lineTo(anchoCelda*2,altoCelda*6)
ctx.moveTo(altoCelda*2,altoCelda*6)
ctx.lineTo(anchoCelda*3,altoCelda*6)
ctx.moveTo(altoCelda*3,altoCelda*6)
ctx.lineTo(anchoCelda*3,altoCelda*8)
//
ctx.moveTo(altoCelda*3,altoCelda*8)
ctx.lineTo(anchoCelda*7,altoCelda*8)
ctx.moveTo(altoCelda*7,altoCelda*8)
ctx.lineTo(anchoCelda*7,altoCelda*7)
ctx.moveTo(altoCelda*7,altoCelda*7)
ctx.lineTo(anchoCelda*4,altoCelda*7)
ctx.moveTo(altoCelda*4,altoCelda*7)
ctx.lineTo(anchoCelda*4,altoCelda*6)
ctx.moveTo(altoCelda*5,altoCelda*2)
ctx.lineTo(anchoCelda*4,altoCelda*2)
ctx.moveTo(altoCelda*4,altoCelda*2)
ctx.lineTo(anchoCelda*4,altoCelda*4)
ctx.moveTo(altoCelda*4,altoCelda*3)
ctx.lineTo(anchoCelda*6,altoCelda*3)
ctx.moveTo(altoCelda*6,altoCelda*3)
ctx.lineTo(anchoCelda*6,altoCelda*4)
ctx.moveTo(altoCelda*7,0)
ctx.lineTo(anchoCelda*7,altoCelda*3)
ctx.moveTo(altoCelda*7,altoCelda*2)
ctx.lineTo(anchoCelda*8,altoCelda*2)
ctx.moveTo(altoCelda*8,altoCelda*2)
ctx.lineTo(anchoCelda*8,altoCelda*4)
ctx.moveTo(altoCelda*8,altoCelda*4)
ctx.lineTo(anchoCelda*10,altoCelda*4)
ctx.moveTo(altoCelda*9,altoCelda*4)
ctx.lineTo(anchoCelda*9,altoCelda*5)
ctx.moveTo(altoCelda*8,altoCelda*7)
ctx.lineTo(anchoCelda*8,altoCelda*10)
ctx.moveTo(altoCelda*8,altoCelda*7)
ctx.lineTo(anchoCelda*10,altoCelda*7)
ctx.moveTo(altoCelda*10,altoCelda*7)
ctx.lineTo(anchoCelda*10,altoCelda*6)
ctx.moveTo(altoCelda*8,altoCelda*6)
ctx.lineTo(anchoCelda*12,altoCelda*6)
ctx.moveTo(altoCelda*12,altoCelda*6)
ctx.lineTo(anchoCelda*12,altoCelda*3)
ctx.moveTo(altoCelda*12,altoCelda*3)
ctx.lineTo(anchoCelda*9,altoCelda*3)
ctx.moveTo(altoCelda*9,altoCelda*2)
ctx.lineTo(anchoCelda*9,altoCelda*3)
ctx.moveTo(altoCelda*9,altoCelda*2)
ctx.lineTo(anchoCelda*12,altoCelda*2)
ctx.moveTo(altoCelda*9,altoCelda*2)
ctx.lineTo(anchoCelda*9,altoCelda*1)
ctx.moveTo(altoCelda*8,altoCelda*1)
ctx.lineTo(anchoCelda*11,altoCelda*1)
ctx.moveTo(altoCelda*13,altoCelda*0)
ctx.lineTo(anchoCelda*13,altoCelda*3)
ctx.moveTo(altoCelda*11,altoCelda*3)
ctx.lineTo(anchoCelda*11,altoCelda*3)
ctx.moveTo(altoCelda*13,altoCelda*2)
ctx.lineTo(anchoCelda*13,altoCelda*8)
ctx.moveTo(altoCelda*13,altoCelda*8)
ctx.lineTo(anchoCelda*9,altoCelda*8)
ctx.moveTo(altoCelda*10,altoCelda*12)
ctx.lineTo(anchoCelda*10,altoCelda*9)
ctx.moveTo(altoCelda*10,altoCelda*9)
